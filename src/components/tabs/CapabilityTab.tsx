          ...
          <div>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h4 className="text-xs font-semibold text-[#faf9f5]">SSE 流式传输 (Stream)</h4>
                  <p className="text-[11px] text-[#9c9689]">长连接实时流式 Chunk 接收支持</p>
                </div>
              </div>
              {capabilities?.stream ? (
            ...
            <div className="mt-4 p-3 rounded-lg bg-[#23211e] border border-[#2e2b27] text-xs text-[#d4cebe]">
              {capabilities?.stream?.details || '检测中转站网关是否放行 SSE 长连接，以及是否会被代理反代缓冲截断。'}
            </div>
          </div>

          <div className="mt-4 flex items-center justify-between text-[11px] font-mono text-[#9c9689] border-t border-[#2e2b27] pt-3">
          ...
          <div>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h4 className="text-xs font-semibold text-[#faf9f5]">Tool / Function Calling</h4>
                  <p className="text-[11px] text-[#9c9689]">Cline / Cursor / Claude Code 工具调用</p>
                </div>
              </div>
              {capabilities?.tools ? (
          ...
          <div>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h4 className="text-xs font-semibold text-[#faf9f5]">Vision 多模态视觉理解</h4>
                  <p className="text-[11px] text-[#9c9689]">Base64 / URL 图片理解与解析</p>
                </div>
              </div>
              {capabilities?.vision ? (
          ...
          <div>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h4 className="text-xs font-semibold text-[#faf9f5]">JSON Mode (结构化输出)</h4>
                  <p className="text-[11px] text-[#9c9689]">response_format: json_object 支持</p>
                </div>
              </div>
              {capabilities?.json ? (
